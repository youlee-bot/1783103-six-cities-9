          ...
          <div className="property__gallery-container container">
            <div className="property__gallery">
              ...
              <div className="property__image-wrapper">
                <img
                  className="property__image"
                  src="../project/src/img/apartment-01.jpg"
                  alt="Property"
                />
              </div>
              <div className="property__image-wrapper">
                <img
                  className="property__image"
                  src="../project/src/img/apartment-02.jpg"
                  alt="Property"
                />
              </div>
              <div className="property__image-wrapper">
                <img
                  className="property__image"
                  src="../project/src/img/apartment-03.jpg"
                  alt="Property"
                />
              </div>
              <div className="property__image-wrapper">
                <img
                  className="property__image"
                  src="../project/src/img/studio-01.jpg"
                  alt="Property"
                />
              </div>
              <div className="property__image-wrapper">
                ...
                <div className="property__host-user user">
                  <div className="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                    <img
                      ...
                      src="../project/src/img/avatar-angelina.jpg"
                      width={74}
                      height={74}
                      alt="Host avatar"
                    />
